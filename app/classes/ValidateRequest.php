...
class ValidateRequest
{
    ...
    /**Summary of abide
     * 
     * @param array $dataAndValues, column and value validate
     * @param array $policies, the rule that validation must satisfy
     * @return void
     */
    ...
    /**perform validation for data provider and set error messages
     * 
     * @param array $data
     * @return void
     */
    ...
    /** 
     * @param mixed $column, field name or column
     * @param mixed $value, value passed into the form
     * @param mixed $policy, the rule thau e set e.g min=5
